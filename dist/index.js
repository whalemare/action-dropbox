...
class DropboxUploader {
    constructor(dropbox, logger) {
        ...
        this.uploadStream = ({ buffer, destination, partSizeBytes = DROPBOX_MAX_BLOB_SIZE, onProgress }) => __awaiter(this, void 0, void 0, function* () {
            ...
            const uploadedFileId = yield blobs.reduce((acc, blob, index, items) => __awaiter(this, void 0, void 0, function* () {
                const isStartUploading = index === 0;
                if (isStartUploading) {
                    onProgress === null || onProgress === void 0 ? void 0 : onProgress(0, buffer.length);
                    return acc.then(() => __awaiter(this, void 0, void 0, function* () { return this.dropbox.filesUploadSessionStart({ contents: blob }).then((response) => response.result.session_id); }));
                }
                else if (index < items.length - 1) {
                    // Append part to the upload session
                    const offset = index * partSize;
                    onProgress === null || onProgress === void 0 ? void 0 : onProgress(offset, buffer.length);
                    return acc.then((sessionId) => __awaiter(this, void 0, void 0, function* () {
                        return this.dropbox
            ...
            onProgress === null || onProgress === void 0 ? void 0 : onProgress(buffer.length, buffer.length);
...
const core = __importStar(__webpack_require__(2186));
const getKeys_1 = __webpack_require__(5762);
function getInputs(raw) {
    return getKeys_1.getKeys(raw).reduce((total, key) => {
        total[key] = core.getInput(key);
        return total;
    }, {});
}
exports.getInputs = getInputs;
const {} = getInputs({ isTrue: 'boolean', count: 'number', name: 'string' });
